...
const intelligenceNav: NavItem[] = [
  ...
  { title: "Dynamic Pricing", href: "/admin/pricing", icon: DollarSign, iconColor: "text-green-600", iconBg: "bg-green-50", badge: "NEW" },
  { title: "Demand Forecast", href: "/admin/forecasting", icon: BarChart3, iconColor: "text-indigo-600", iconBg: "bg-indigo-50", badge: "NEW" },
  { title: "Fraud & Security", href: "/admin/fraud", icon: ShieldAlert, iconColor: "text-red-600", iconBg: "bg-red-50", badge: "NEW" },
  { title: "Chatbot AI", href: "/admin/chatbot", icon: MessageCircle, iconColor: "text-purple-600", iconBg: "bg-purple-50", badge: "NEW" },
  { title: "Smart UX", href: "/admin/smart-ux", icon: MousePointerClick, iconColor: "text-pink-600", iconBg: "bg-pink-50", badge: "NEW" },
];
...
const managementNav: NavItem[] = [
  ...
  { title: "Alerts", href: "/admin/alerts", icon: Bell, iconColor: "text-red-600", iconBg: "bg-red-50" },
