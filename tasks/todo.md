...
Last updated: 2026-03-27 (External Engine API Integration complete)
...
### Engine Governor — Phase 6: External Engine API Integration (COMPLETE — 2026-03-27)
- [x] G-038: Define ExternalEngineRecord types — `governor/types.ts`
- [x] G-039: Create external_engines migration — `033_external_engines.sql`
- [x] G-040: Build external adapter — `governor/external-adapter.ts` (HTTP, auth, circuit breaker)
- [x] G-041: Enhance dispatch for external routing — `governor/dispatch.ts` (dual cache)
- [x] G-042: External engines CRUD API — `/api/admin/governor/external-engines/`
- [x] G-043: External engines test API — `/api/admin/governor/external-engines/test/`
- [x] G-044: Update swaps API for external — `isExternal` + `externalEngineId` support
- [x] G-045: Admin external engines page — `/admin/governor/engines`
- [x] G-046: Enhanced swap page UI — Internal/External toggle
- [x] G-047: Governor dashboard update — External Engines button in header
