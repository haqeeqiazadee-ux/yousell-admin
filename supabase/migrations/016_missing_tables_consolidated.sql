-- ============================================================
-- 016_missing_tables_consolidated.sql
-- Creates all tables that may be missing from earlier migrations
-- Safe to run multiple times (uses IF NOT EXISTS)
-- ============================================================

-- ============================================================
-- TikTok Videos (from 010)
-- ============================================================
...
-- ============================================================
-- TikTok Hashtag Signals (from 011)
-- ============================================================
...
-- ============================================================
-- Creator Product Matches (from 013)
-- ============================================================
...
-- ============================================================
-- Add missing columns to competitors (from 014)
-- ============================================================
...
-- ============================================================
-- Ensure platform column on products supports all needed values
-- If using enum, alter it; if text, no change needed
-- ============================================================
DO $$ BEGIN
  -- Try adding new enum values if product_platform enum exists
